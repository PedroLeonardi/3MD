...
('Pedro Almoxarifado', 'pedro.a', 'senha_hashed_1'),
('Ramon Gerente', 'ramon.g', 'senha_hashed_2'),
('davi Estagiario', 'davi.e', 'senha_hashed_3');
...
('Cimento 50kg', 'Cimento Portland composto', 'Saco', 5, 20, '2026-07-15', 'Tipo: Estrutural'),
('tijolo', '18x20 cm', 'unidade', 15, 10, NULL, 'cor: laranja'),
('Barra de Aço CA-50 3/8"', 'Barra de Aço para estruturas', 'Barra', 50, 50, NULL, 'Diâmetro: 10mm');
